...
import { MockCapasBooks } from "../utils/mocks";
    ...
    <section className="flex flex-col items-center">
      ...
      <section className="w-full h-auto bg-gray-300 flex sm:flex-col md:flex-col flex-row gap-4 items-center justify-around p-8">
        <div className="w-6/12 sm:w-full md:w-full flex justify-between">
          <CardBooks img={MockCapasBooks[0].liderança.img} alt={MockCapasBooks[0].liderança.alt} />
          <CardBooks img={MockCapasBooks[0].apache.img} alt={MockCapasBooks[0].apache.alt} />
          <CardBooks img={MockCapasBooks[0].javaScript.img} alt={MockCapasBooks[0].javaScript.alt} />
        </div>
